#!/usr/bin/env python
# ------------------------------------------------------------------------------------------------------%
# Created by "Thieu Nguyen" at 01:21, 29/03/2020                                                        %
#                                                                                                       %
...
from models.main.hybrid_elm import GaElm
from utils.IOUtil import _load_dataset__
from utils.Settings import *
from utils.Settings import ga_elm_final as param_grid
...
def train_model(item):
    ...
    paras_name = "hs_{}-ac_{}--ep_{}-ps_{}-pc_{}-pm_{}".format(item["hidden_size"], item["activation"], item["epoch"], item["pop_size"], item["pc"],item["pm"])
    root_hybrid_paras = {
        "hidden_size": item["hidden_size"], "activation": item["activation"], "domain_range": item["domain_range"], "paras_name": paras_name
    }
