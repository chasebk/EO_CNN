#!/usr/bin/env python
# ------------------------------------------------------------------------------------------------------%
# Created by "Thieu Nguyen" at 18:49, 29/03/2020                                                        %
#                                                                                                       %
...
from models.main.hybrid_cnn import SsdoCnn
from utils.IOUtil import _load_dataset__
from utils.Settings import *
from utils.Settings import ssdo_cnn_final as param_grid
...
def train_model(item):
    ...
    ssdo_paras = {"epoch": item["epoch"], "pop_size": item["pop_size"]}

    md = SsdoCnn(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, cnn_paras=cnn_paras, ssdo_paras=ssdo_paras)
    md._running__()
