#!/usr/bin/env python
# ------------------------------------------------------------------------------------------------------%
# Created by "Thieu Nguyen" at 18:45, 29/03/2020                                                        %
#                                                                                                       %
...
from models.main.hybrid_cnn import MvoCnn
from utils.IOUtil import _load_dataset__
from utils.Settings import *
from utils.Settings import mvo_cnn_final as param_grid
...
def train_model(item):
    ...
    paras_name = "hs_{}-ac_{}--fs_{}-ks_{}-ps_{}--ep_{}-ps_{}-wep_minmax_{}".format(item["hidden_sizes"], item["activations"], item["filters_size"],
                    item["kernel_size"], item["pool_size"], item["epoch"], item["pop_size"], item["wep_minmax"])
    root_hybrid_paras = {
    ...
    md = MvoCnn(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, cnn_paras=cnn_paras, mvo_paras=mvo_paras)
    md._running__()
