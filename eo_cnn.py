#!/usr/bin/env python
# ------------------------------------------------------------------------------------------------------%
# Created by "Thieu Nguyen" at 15:58, 03/04/2020                                                        %
#                                                                                                       %
...
from models.main.hybrid_cnn import EoCnn
from utils.IOUtil import _load_dataset__
from utils.Settings import *
from utils.Settings import eo_cnn_final as param_grid
...
def train_model(item):
    ...
    md = EoCnn(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, cnn_paras=cnn_paras, eo_paras=eo_paras)
    md._running__()
