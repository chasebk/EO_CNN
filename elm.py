#!/usr/bin/env python
# ------------------------------------------------------------------------------------------------------%
# Created by "Thieu Nguyen" at 01:00, 29/03/2020                                                        %
#                                                                                                       %
...
from models.main.traditional_elm import Elm
from utils.IOUtil import _load_dataset__
from utils.Settings import *
from utils.Settings import elm_final as param_grid
...
def train_model(item):
    ...
    paras_name = "hs_{}-ac_{}".format(item["hidden_size"], item["activation"])
    root_elm_paras = {
