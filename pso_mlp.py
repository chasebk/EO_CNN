...
def train_model(item):
    ...
    paras_name = "hs_{}-ac_{}--ep_{}-ps_{}-c1_{}-c2_{}-w_min_{}-w_max_{}".format(item["hidden_size"], item["activations"], item["epoch"], item["pop_size"],
                                                                                 item["c1"], item["c2"], item["w_min"], item["w_max"])
    root_hybrid_paras = {
