#!/usr/bin/env python
# ------------------------------------------------------------------------------------------------------%
# Created by "Thieu Nguyen" at 16:04, 03/04/2020                                                        %
#                                                                                                       %
...
from models.main.hybrid_cnn import AeoCnn
from utils.IOUtil import _load_dataset__
from utils.Settings import *
from utils.Settings import aeo_cnn_final as param_grid
...
def train_model(item):
    ...
    aeo_paras = {"epoch": item["epoch"], "pop_size": item["pop_size"]}

    md = AeoCnn(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, cnn_paras=cnn_paras, aeo_paras=aeo_paras)
    md._running__()
