...
from models.main.hybrid_lstm import WoaLstm
from utils.IOUtil import _load_dataset__
from utils.Settings import *
from utils.Settings import woa_lstm_final as param_grid
...
def train_model(item):
    ...
    md = WoaLstm(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, woa_paras=woa_paras)
    md._running__()
